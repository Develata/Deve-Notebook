...
check_contains apps/web/src/api/service.rs "fn dashboard_metrics_stale_connection_epoch_is_not_current()"
...
check_contains apps/web/src/hooks/use_core/effects/message.rs "is_current_connection_message(connection_epoch"
