...
expect_ok ghcr.io/acme/deve:1.2.3-rc.1 ghcr.io/acme/deve:latest \
  1.2.3-rc.1 ghcr.io/acme/deve:latest ghcr.io/acme/deve:1.2.3-rc.1
expect_ok ghcr.io/acme/deve:1.2.3-build.7 ghcr.io/acme/deve:latest \
  1.2.3-build.7 ghcr.io/acme/deve:1.2.3-build.7 ghcr.io/acme/deve:latest
