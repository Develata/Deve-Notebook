...
ARTIFACTS="${DEVE_NATIVE_TARGET_HOST_EVIDENCE_ARTIFACTS:-deve-native-target-host-evidence-macos,deve-native-target-host-evidence-windows,deve-native-target-host-evidence-android,deve-native-target-host-evidence-ios}"
