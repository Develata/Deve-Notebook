...
contains apps/web/src/components/chat/panel_status.rs "data-deve-chat-error-banner=move || chat_error_banner_marker(error_code.get().is_some())"
contains apps/web/src/components/chat/panel_status.rs "data-deve-chat-action=move || chat_retry_button_marker(error_code.get().is_some())"
contains apps/web/src/components/chat/panel_status.rs "fn mobile_chat_error_banner_marker_is_visible_only_on_error()"
contains apps/web/src/components/chat/panel_status.rs "fn mobile_chat_error_retry_button_marker_is_stable()"
contains apps/web/src/components/chat/panel_status.rs "fn mobile_chat_error_retry_button_is_at_least_44px()"
contains apps/web/src/components/chat/panel.rs "pub(crate) fn chat_retry_prompt("
contains apps/web/src/components/chat/panel.rs "fn mobile_chat_error_retry_uses_last_prompt()"
contains apps/web/src/components/chat/panel.rs "fn mobile_chat_error_retry_ignores_empty_prompt()"
...
contains apps/web/src/components/mobile_layout/drawers/left_tabs.rs "data-deve-mobile-sidebar-icon-tabs=move || mobile_sidebar_icon_tabs_marker(open.get())"
contains apps/web/src/components/mobile_layout/drawers/left_tabs.rs "data-deve-mobile-sidebar-action=mobile_more_button_marker()"
contains apps/web/src/components/mobile_layout/drawers/left_tabs.rs "data-deve-mobile-touch-target=mobile_more_button_marker()"
contains apps/web/src/components/mobile_layout/drawers/left_tabs.rs "fn mobile_sidebar_icon_tabs_marker_is_visible_when_drawer_open()"
contains apps/web/src/components/mobile_layout/drawers/left_tabs.rs "fn mobile_sidebar_more_button_marker_is_stable()"
contains apps/web/src/components/mobile_layout/drawers/left_tabs.rs "fn mobile_sidebar_more_button_is_at_least_44px()"
contains apps/web/src/components/mobile_layout/drawers/left_tab_button.rs "data-deve-mobile-sidebar-tab=sidebar_tab_marker(view)"
contains apps/web/src/components/mobile_layout/drawers/left_tab_button.rs "data-deve-mobile-sidebar-tab-active=move || (active_view.get() == view).to_string()"
contains apps/web/src/components/mobile_layout/drawers/left_tab_button.rs "fn mobile_sidebar_icon_tab_markers_cover_sidebar_entries()"
contains apps/web/src/components/mobile_layout/drawers/left_tab_button.rs "fn mobile_sidebar_icon_tab_classes_cover_sidebar_entries()"
...
contains apps/web/src/components/mobile_layout/drawers/left_more_menu.rs "pub(super) fn mobile_more_after_item_click() -> bool"
