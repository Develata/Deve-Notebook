...
contains apps/web/src/components/main_layout/contexts.rs "pub(crate) const MOBILE_BREAKPOINT_WIDTH: f64 = 768.0;"
contains apps/web/src/components/main_layout/contexts.rs "pub(crate) fn viewport_width_maps_to_mobile(width: f64) -> bool"
contains apps/web/src/components/main_layout/contexts.rs "fn mobile_viewport_mapping_uses_inclusive_768px_boundary()"
...
contains apps/web/src/components/desktop_layout/handles.rs "class=\"resizer-handle"
...
contains apps/web/src/components/search_box/ui_sheet/style.rs "data-deve-search-sheet-handle=\"top\""
contains apps/web/src/components/search_box/ui_sheet/style.rs "SearchUiMode::Overlay => None"
contains apps/web/src/components/search_box/ui_sheet/style.rs "fn mobile_search_sheet_is_positioned_at_top()"
...
contains apps/web/src/components/mobile_layout/drawers/left/header.rs "data-deve-mobile-touch-target=\"drawer_close_buttons\""
contains apps/web/src/components/mobile_layout/drawers/left/header.rs "fn mobile_touch_targets_left_drawer_close_button_is_at_least_44px()"
...
contains apps/web/src/components/mobile_layout/drawers/left/header.rs "t::sidebar::close_file_tree(locale.get())"
...
# UI-MOB-012: mobile AI Chat keeps the input and send action reachable above
# the virtual keyboard, and hides Bottom Bar while the chat page is expanded.
contains docs/acceptance-cases/05_ui.md "case_id: UI-MOB-012"
contains_case_block UI-MOB-012 "run: scripts/check-mobile-baseline.sh"
contains_case_block UI-MOB-012 "run: cargo test -p deve_web mobile_chat_keyboard -- --nocapture"
contains_case_block UI-MOB-012 "ui_focus: \"chat_input\""
contains_case_block UI-MOB-012 "ui_wait_keyboard: true"
contains_case_block UI-MOB-012 "ui_measure: \"chat_send_button\""
contains_case_block UI-MOB-012 "cli_assert: mobile_chat_input_marker_bound true"
contains_case_block UI-MOB-012 "cli_assert: mobile_chat_send_button_marker_bound true"
contains_case_block UI-MOB-012 "cli_assert: mobile_chat_keyboard_offset_bound true"
contains_case_block UI-MOB-012 "cli_assert: mobile_chat_bottom_bar_hidden_bound true"
contains_case_block UI-MOB-012 "ui_assert: chat_input_not_overlapped_by_keyboard true"
contains_case_block UI-MOB-012 "ui_assert: min_target_size \"44x44\""
contains_case_block UI-MOB-012 "ui_assert: bottom_bar_hidden true"
contains docs/acceptance-cases/13_ui_mobile_chat_regression.md "case_id: UI-MOB-CHAT-REG-002"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-002 "run: scripts/check-mobile-baseline.sh"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-002 "run: cargo test -p deve_web mobile_chat_keyboard -- --nocapture"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-002 "ui_focus: \"chat_input\""
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-002 "ui_wait_keyboard: true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-002 "ui_measure: \"chat_send_button\""
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-002 "cli_assert: mobile_chat_input_marker_bound true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-002 "cli_assert: mobile_chat_send_button_marker_bound true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-002 "cli_assert: mobile_chat_keyboard_offset_bound true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-002 "cli_assert: mobile_chat_bottom_bar_hidden_bound true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-002 "ui_assert: chat_input_not_overlapped_by_keyboard true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-002 "ui_assert: min_target_size \"44x44\""
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-002 "ui_assert: bottom_bar_hidden true"
contains apps/web/src/components/chat/input_area.rs "data-deve-mobile-chat-input-area=move || mobile_chat_input_area_marker(mobile)"
contains apps/web/src/components/chat/input_area.rs "data-deve-mobile-chat-input=move || mobile_chat_input_marker(mobile)"
contains apps/web/src/components/chat/input_area.rs "data-deve-mobile-chat-action=move || mobile_chat_send_button_marker(mobile)"
contains apps/web/src/components/chat/input_area.rs "data-deve-mobile-touch-target=move || mobile_chat_send_button_marker(mobile)"
contains apps/web/src/components/chat/input_area.rs "fn mobile_chat_keyboard_input_area_uses_safe_area_padding()"
contains apps/web/src/components/chat/input_area.rs "fn mobile_chat_keyboard_send_button_is_at_least_44px()"
contains apps/web/src/components/chat/input_area.rs "fn mobile_chat_keyboard_markers_are_mobile_only()"
...
# horizontally scrollable, and timestamps visible.
contains docs/acceptance-cases/05_ui.md "case_id: UI-MOB-013"
contains_case_block UI-MOB-013 "run: scripts/check-mobile-baseline.sh"
contains_case_block UI-MOB-013 "run: cargo test -p deve_web mobile_chat_readability -- --nocapture"
contains_case_block UI-MOB-013 "ui_send_chat_text: \"long_text_and_code_sample\""
contains_case_block UI-MOB-013 "ui_wait: 500"
contains_case_block UI-MOB-013 "cli_assert: mobile_chat_message_wrap_bound true"
contains_case_block UI-MOB-013 "cli_assert: mobile_chat_code_block_scroll_bound true"
contains_case_block UI-MOB-013 "cli_assert: mobile_chat_timestamp_marker_bound true"
contains_case_block UI-MOB-013 "ui_assert: chat_message_wrap_enabled true"
contains_case_block UI-MOB-013 "ui_assert: chat_code_block_horizontal_scroll true"
contains_case_block UI-MOB-013 "ui_assert: chat_message_timestamp_visible true"
contains docs/acceptance-cases/13_ui_mobile_chat_regression.md "case_id: UI-MOB-CHAT-REG-003"
contains docs/acceptance-cases/13_ui_mobile_chat_regression.md "case_id: UI-MOB-CHAT-REG-004"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-004 "run: scripts/check-mobile-baseline.sh"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-004 "run: cargo test -p deve_web mobile_chat_readability -- --nocapture"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-004 "ui_send_chat_text: \"long_text_and_code_sample\""
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-004 "ui_wait: 500"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-004 "cli_assert: mobile_chat_message_wrap_bound true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-004 "cli_assert: mobile_chat_code_block_scroll_bound true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-004 "cli_assert: mobile_chat_timestamp_marker_bound true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-004 "ui_assert: chat_message_wrap_enabled true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-004 "ui_assert: chat_code_block_horizontal_scroll true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-004 "ui_assert: chat_message_timestamp_visible true"
contains apps/web/src/components/chat/message_item.rs "data-deve-mobile-chat-message=move || mobile_chat_message_marker(mobile)"
contains apps/web/src/components/chat/message_item.rs "data-deve-mobile-chat-wrap=move || mobile_chat_wrap_marker(mobile)"
contains apps/web/src/components/chat/message_item.rs "data-deve-mobile-chat-code-scroll=move || mobile_chat_code_scroll_marker(mobile)"
contains apps/web/src/components/chat/message_item.rs "data-deve-mobile-chat-timestamp=move || mobile_chat_timestamp_marker(mobile)"
contains apps/web/src/components/chat/message_item.rs "fn mobile_chat_readability_bubble_keeps_wide_wrap_surface()"
contains apps/web/src/components/chat/message_item.rs "fn mobile_chat_readability_markdown_wrap_and_code_scroll_are_bound()"
contains apps/web/src/components/chat/message_item.rs "fn mobile_chat_readability_markers_are_mobile_only()"
contains apps/web/style/tailwind.css ".markdown-body"
contains apps/web/style/tailwind.css "overflow-wrap: anywhere;"
contains apps/web/style/_code-block.css ".markdown-code-block pre"
contains apps/web/style/_code-block.css "overflow-x: auto;"

# UI-MOB-014: mobile AI Chat exposes a visible error banner and a stable
# retry action that reuses the last non-empty prompt.
contains docs/acceptance-cases/05_ui.md "case_id: UI-MOB-014"
contains_case_block UI-MOB-014 "run: scripts/check-mobile-baseline.sh"
contains_case_block UI-MOB-014 "run: cargo test -p deve_web mobile_chat_error -- --nocapture"
contains_case_block UI-MOB-014 "ui_send_chat_text: \"trigger_error\""
contains_case_block UI-MOB-014 "ui_click: \"chat_retry_button\""
contains_case_block UI-MOB-014 "cli_assert: mobile_chat_error_banner_marker_bound true"
contains_case_block UI-MOB-014 "cli_assert: mobile_chat_retry_button_marker_bound true"
contains_case_block UI-MOB-014 "cli_assert: mobile_chat_retry_prompt_bound true"
contains_case_block UI-MOB-014 "ui_assert: chat_error_banner_visible true"
contains_case_block UI-MOB-014 "ui_assert: retry_action_triggered true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-003 "run: scripts/check-mobile-baseline.sh"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-003 "run: cargo test -p deve_web mobile_chat_error -- --nocapture"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-003 "ui_send_chat_text: \"trigger_error\""
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-003 "ui_assert: chat_error_banner_visible true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-003 "ui_click: \"chat_retry_button\""
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-003 "cli_assert: mobile_chat_error_banner_marker_bound true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-003 "cli_assert: mobile_chat_retry_button_marker_bound true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-003 "cli_assert: mobile_chat_retry_prompt_bound true"
contains_case_block_in_file docs/acceptance-cases/13_ui_mobile_chat_regression.md UI-MOB-CHAT-REG-003 "ui_assert: retry_action_triggered true"
contains docs/acceptance-bindings.tsv "UI-MOB-014|manual-chrome|docs/features/10_ai_agent.md|mobile chat error recovery workflow"
contains apps/web/src/components/chat/panel/status.rs "data-deve-chat-error-banner=move || chat_error_banner_marker(error_code.get().is_some())"
contains apps/web/src/components/chat/panel/status.rs "data-deve-chat-action=move || chat_retry_button_marker(error_code.get().is_some())"
contains apps/web/src/components/chat/panel/status.rs "fn mobile_chat_error_banner_marker_is_visible_only_on_error()"
contains apps/web/src/components/chat/panel/status.rs "fn mobile_chat_error_retry_button_marker_is_stable()"
contains apps/web/src/components/chat/panel/status.rs "fn mobile_chat_error_retry_button_is_at_least_44px()"
contains apps/web/src/components/chat/panel/mod.rs "pub(crate) fn chat_retry_prompt("
contains apps/web/src/components/chat/panel/mod.rs "fn mobile_chat_error_retry_uses_last_prompt()"
contains apps/web/src/components/chat/panel/mod.rs "fn mobile_chat_error_retry_ignores_empty_prompt()"

# UI-MOB-015: mobile left drawer exposes ActivityBar-style icon tabs and a
# More menu with all sidebar entries.
contains docs/acceptance-cases/05_ui.md "case_id: UI-MOB-015"
contains_case_block UI-MOB-015 "run: scripts/check-mobile-baseline.sh"
contains_case_block UI-MOB-015 "run: cargo test -p deve_web mobile_sidebar -- --nocapture"
contains_case_block UI-MOB-015 "ui_open_drawer: \"left\""
contains_case_block UI-MOB-015 "ui_assert: sidebar_icon_tabs_visible true"
contains_case_block UI-MOB-015 "ui_click: \"mobile-more-button\""
contains_case_block UI-MOB-015 "ui_assert: more_menu_visible true"
contains_case_block UI-MOB-015 "cli_assert: mobile_sidebar_icon_tabs_marker_bound true"
contains_case_block UI-MOB-015 "cli_assert: mobile_sidebar_tab_markers_bound true"
contains_case_block UI-MOB-015 "cli_assert: mobile_more_button_marker_bound true"
contains_case_block UI-MOB-015 "cli_assert: mobile_more_menu_marker_bound true"
contains_case_block UI-MOB-015 "cli_assert: mobile_more_menu_items_bound true"
contains_case_block UI-MOB-015 "ui_assert: sidebar_icon_count_at_least 1"
contains_case_block UI-MOB-015 "ui_assert: more_menu_has_sidebar_entries true"
contains docs/acceptance-bindings.tsv "UI-MOB-015|manual-chrome|docs/features/08_ui_design_03_mobile.md|mobile sidebar more workflow"
contains apps/web/src/components/mobile_layout/drawers/left/tabs.rs "data-deve-mobile-sidebar-icon-tabs=move || mobile_sidebar_icon_tabs_marker(open.get())"
contains apps/web/src/components/mobile_layout/drawers/left/tabs.rs "data-deve-mobile-sidebar-action=mobile_more_button_marker()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs.rs "data-deve-mobile-touch-target=mobile_more_button_marker()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs.rs "fn mobile_sidebar_icon_tabs_marker_is_visible_when_drawer_open()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs.rs "fn mobile_sidebar_more_button_marker_is_stable()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs.rs "fn mobile_sidebar_more_button_is_at_least_44px()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/tab_button.rs "data-deve-mobile-sidebar-tab=sidebar_tab_marker(view)"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/tab_button.rs "data-deve-mobile-sidebar-tab-active=move || (active_view.get() == view).to_string()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/tab_button.rs "fn mobile_sidebar_icon_tab_markers_cover_sidebar_entries()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/tab_button.rs "fn mobile_sidebar_icon_tab_classes_cover_sidebar_entries()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu.rs "data-deve-mobile-more-menu=move || mobile_more_menu_marker(show_more.get())"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu.rs "data-deve-mobile-more-item=mobile_more_item_marker(item)"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu.rs "data-deve-mobile-more-pin-action=mobile_more_pin_action_marker(item)"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu/tests.rs "fn mobile_sidebar_more_menu_marker_is_visible_when_open()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu/tests.rs "fn mobile_sidebar_more_menu_items_cover_sidebar_entries()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu/tests.rs "fn mobile_sidebar_more_menu_reuses_desktop_entry_classes()"

# UI-MOB-016: mobile More menu closes on item select and Escape, while Pin
# only updates the pinned set.
contains docs/acceptance-cases/05_ui.md "case_id: UI-MOB-016"
contains_case_block UI-MOB-016 "run: scripts/check-mobile-baseline.sh"
contains_case_block UI-MOB-016 "run: cargo test -p deve_web mobile_sidebar_more -- --nocapture"
contains_case_block UI-MOB-016 "ui_click: \"mobile-more-button\""
contains_case_block UI-MOB-016 "ui_click: \"more_menu_item_explorer\""
contains_case_block UI-MOB-016 "ui_assert: more_menu_visible false"
contains_case_block UI-MOB-016 "ui_click: \"more_menu_pin_search\""
contains_case_block UI-MOB-016 "ui_assert: pinned_state_updated true"
contains_case_block UI-MOB-016 "ui_assert: more_menu_visible true"
contains_case_block UI-MOB-016 "ui_press_key: \"Escape\""
contains_case_block UI-MOB-016 "cli_assert: mobile_more_item_close_bound true"
contains_case_block UI-MOB-016 "cli_assert: mobile_more_escape_close_bound true"
contains_case_block UI-MOB-016 "cli_assert: mobile_more_pin_action_marker_bound true"
contains_case_block UI-MOB-016 "cli_assert: mobile_more_pin_toggle_bound true"
contains_case_block UI-MOB-016 "cli_assert: mobile_more_pin_keeps_menu_open_bound true"
contains docs/acceptance-bindings.tsv "UI-MOB-016|manual-chrome|docs/features/08_ui_design_03_mobile.md|mobile more menu pin workflow"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu.rs "pub(super) fn mobile_more_after_item_click() -> bool"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu.rs "pub(super) fn mobile_more_after_escape() -> bool"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu.rs "pub(super) fn mobile_more_after_pin_click(open: bool) -> bool"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu.rs "pub(super) fn toggle_mobile_more_pin("
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu/tests.rs "fn mobile_sidebar_more_pin_actions_cover_sidebar_entries()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu/tests.rs "fn mobile_sidebar_more_item_click_closes_menu()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu/tests.rs "fn mobile_sidebar_more_escape_closes_menu()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu/tests.rs "fn mobile_sidebar_more_pin_click_keeps_menu_state()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu/tests.rs "fn mobile_sidebar_more_pin_toggle_adds_unpinned_view()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu/tests.rs "fn mobile_sidebar_more_pin_toggle_removes_pinned_view_when_not_last()"
contains apps/web/src/components/mobile_layout/drawers/left/tabs/more_menu/tests.rs "fn mobile_sidebar_more_pin_toggle_keeps_last_view_pinned()"
...
contains_case_block UI-MOB-019 "cli_assert: mobile_toolbar_uses_repo_write_gate true"
...
contains_case_block_in_file docs/acceptance-cases/17_mobile_surface_switcher.md UI-MOB-021 "cli_assert: mobile_surface_close_diff_keeps_source_control_state true"
...
contains apps/web/src/components/mobile_layout/surface_switcher/rows.rs "data-deve-mobile-surface-action=\"mobile_surface_document_row\""
contains apps/web/src/components/mobile_layout/surface_switcher/rows.rs "data-deve-mobile-surface-action=\"mobile_surface_diff_row\""
...
contains apps/web/src/components/editor_tabs/tests.rs "fn mobile_surface_close_diff_keeps_source_control_state()"
