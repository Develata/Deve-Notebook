...
check_contains docs/features/operations/settings_ui_preferences.md "deve.ui.max_document_tabs"
...
check_contains apps/web/src/components/settings_prefs.rs "pub(crate) const MAX_DOCUMENT_TABS_PREF_KEY: &str = \"deve.ui.max_document_tabs\";"
check_contains apps/web/src/components/settings_prefs.rs "max_document_tabs_preference_defaults_clamps_and_roundtrips"
check_contains apps/web/src/components/layout_context.rs "pub struct EditorTabLimitControl"
check_contains apps/web/src/components/main_layout/setup.rs "init_editor_tab_limit_ui_state"
check_contains apps/web/src/components/settings_sections/local_prefs.rs "data-deve-settings-editor-wrap"
check_contains apps/web/src/components/settings_sections/local_prefs.rs "data-deve-settings-max-document-tabs"
check_contains apps/web/src/components/settings_sections/local_prefs.rs "submitted_max_document_tabs"
check_contains apps/web/src/components/settings_sections/local_prefs.rs "max_document_tabs_draft"
check_contains apps/web/src/components/settings_sections/local_prefs.rs "on:change"
check_contains apps/web/src/components/settings_sections/local_prefs.rs "on:blur"
...
check_contains apps/web/src/components/settings.rs "settings_modal_uses_icon_close_only"
check_absent apps/web/src/components/settings.rs "data-deve-settings-close=\"primary\""
...
check_contains docs/acceptance-cases/15_settings_operation_refs.md "ui_submit_number: \"max_document_tabs\""
check_contains docs/acceptance-cases/15_settings_operation_refs.md "ui_assert: settings_primary_close_absent true"
check_contains docs/acceptance-cases/15_settings_operation_refs.md "ui_assert: max_document_tabs_pref_unchanged_before_submit true"
...
check_contains docs/features/13_settings.md "主题、自动换行、编辑器密度、最大文档 tab 数"
