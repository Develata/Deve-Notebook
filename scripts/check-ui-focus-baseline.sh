...
contains docs/plan/11_ui_design/index.md "Modal MUST trap focus"
contains docs/plan/11_ui_design/index.md "restore previous focus target"
contains docs/plan/11_ui_design/index.md '被折叠到 `aria-hidden=true` 前'
contains docs/plan/11_ui_design/index.md "两阶段状态"
...
contains apps/web/src/components/focus_scope.rs "blur_active_element_inside"
...
contains apps/web/src/components/focus_scope.rs "focus_scope_blurs_only_when_active_element_is_inside_surface"
contains apps/web/src/components/desktop_layout/sidebar.rs "focus_scope::blur_active_element_inside"
contains apps/web/src/components/desktop_layout/sidebar.rs "surface_hidden"
contains apps/web/src/components/desktop_layout/sidebar.rs "aria-hidden=move || surface_hidden.get().to_string()"
contains apps/web/src/components/desktop_layout/content.rs "focus_scope::blur_active_element_inside"
contains apps/web/src/components/desktop_layout/content.rs "surface_hidden"
contains apps/web/src/components/desktop_layout/content.rs "aria-hidden=move || surface_hidden.get().to_string()"
contains apps/web/src/components/desktop_chat_panel.rs "focus_scope::blur_active_element_inside"
contains apps/web/src/components/desktop_chat_panel.rs "surface_hidden"
contains apps/web/src/components/desktop_chat_panel.rs "aria-hidden=move || surface_hidden.get().to_string()"
