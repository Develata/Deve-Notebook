...
contains "$RUNBOOK" 'Native Authority Opt-in'
contains "$RUNBOOK" 'DEVE_NATIVE_AUTHORITY=1 DEVE_DESKTOP_LOCAL_SERVICE=1'
contains "$RUNBOOK" 'DEVE_NATIVE_AUTHORITY=1 DEVE_MOBILE_EMBEDDED_SERVICE=1'
