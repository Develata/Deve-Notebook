...
contains "docs/report/desktop-process-runtime-gate-decision-2026-05-14.md" "Android Mobile shell package execution is verified"
contains "docs/report/desktop-process-runtime-gate-decision-2026-05-14.md" "iOS Mobile package execution remains target-host work"
