...
check_contains apps/web/src/components/diff_view/state_compute_helpers.rs "fn diff_first_viewport_large_single_line_defers_cache_key()"
check_contains apps/web/src/components/diff_view/state_compute_helpers.rs "fn diff_first_viewport_large_single_line_preview_is_byte_bounded()"
check_contains apps/web/src/components/diff_view/state_compute_helpers.rs "fn diff_first_viewport_preview_respects_utf8_byte_boundary()"
