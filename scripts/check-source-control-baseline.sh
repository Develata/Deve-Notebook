...
check_contains apps/cli/src/server/source_control_http_test/status.rs "test_http_status_rejects_selector_mismatch"
check_contains apps/cli/src/server/source_control_http_test/status.rs "ServerErrorCode::ScRepoContextInvalid"
