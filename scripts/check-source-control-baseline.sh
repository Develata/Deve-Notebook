...
check_contains apps/cli/src/server/ws/route/source_control_test.rs "source_control_scope_nonce_gate_rejects_missing_scope_before_handler"
check_contains apps/web/src/components/sidebar/source_control/commit_actions.rs "on_commit_and_push.run(())"
check_contains apps/web/src/i18n/source_control_actions.rs "Commit & Push"
...
check_contains apps/web/src/components/diff_view/state_compute_helpers.rs "pub key: Option<String>"
...
check_contains apps/web/src/components/diff_view/state_compute_helpers.rs "pub const INITIAL_DIFF_PREVIEW_BYTES"
check_contains apps/web/src/components/diff_view/state_compute_helpers.rs "fn exceeds_preview_window("
check_contains apps/web/src/components/diff_view/state_compute_helpers_test.rs "fn diff_first_viewport_initial_cache_miss_uses_preview()"
check_contains apps/web/src/components/diff_view/state_compute_helpers_test.rs "fn diff_first_viewport_long_initial_defers_cache_key()"
check_contains apps/web/src/components/diff_view/state_compute_helpers_test.rs "fn diff_first_viewport_short_initial_builds_cache_key()"
check_contains apps/web/src/components/diff_view/state_compute_helpers_test.rs "fn diff_first_viewport_large_single_line_defers_cache_key()"
check_contains apps/web/src/components/diff_view/state_compute_helpers_test.rs "fn diff_first_viewport_large_single_line_preview_is_byte_bounded()"
check_contains apps/web/src/components/diff_view/state_compute_helpers_test.rs "fn diff_first_viewport_preview_respects_utf8_byte_boundary()"
check_contains apps/web/src/components/diff_view/state_compute_helpers_test.rs "fn diff_first_viewport_initial_short_cache_miss_is_complete()"
...
check_contains crates/core/tests/commit_diff_node_projection/projection.rs "assert_eq!(diffs[0].doc_id, Some(doc_id));"
...
check_contains apps/web/src/hooks/use_core/effects_sc_apply_test.rs "apply_doc_diff_preserves_doc_identity"
...
check_contains crates/core/src/ledger/manager/source_control_target_lookup/tests.rs "resolve_from_entries_rejects_unrelated_same_doc_live_entry"
...
check_contains crates/core/tests/source_control_commit_apply_error/target.rs "commit_staged_rejects_upsert_target_when_path_is_bound_to_another_doc"
check_contains crates/core/tests/source_control_commit_apply_error/target.rs "commit_staged_rejects_upsert_move_without_rename_evidence"
