...
check_contains apps/cli/src/server/source_control_proxy/mod.rs "delegated_get"
check_contains apps/cli/src/server/source_control_proxy/mod.rs "impl DelegatedSourceControlApi for RemoteSourceControlApi"
check_contains apps/cli/src/server/source_control_proxy/mod.rs "delegated_source_control_proxy_api_is_type_marked"
...
check_contains apps/cli/src/commands/serve.rs "Arc<dyn deve_core::source_control::DelegatedSourceControlApi>"
check_contains apps/cli/src/server/router.rs "delegated_source_control_middleware"
check_contains apps/cli/src/server/router.rs '"/api/delegated/sc/status"'
check_contains apps/cli/src/server/auth/delegated_source_control.rs "delegated source control capability missing"
check_contains docs/features/07_diff_logic.md "proxy 模式的只读 repo/source-control 查询必须走 delegated read capability"
...
check_contains docs/acceptance-cases/04_diff.md "cargo test -p deve_cli source_control_write_grant_creation_fails_closed -- --nocapture"
...
check_contains docs/acceptance-cases/04_diff.md "cargo test -p deve_core --lib source_control_write_gate_rejects_broken_workspace_identity -- --nocapture"
check_contains docs/acceptance-cases/04_diff.md "cargo test -p deve_core --test plugin_source_control_gate_test plugin_sc_commit_respects_git_bridge_off -- --nocapture"
check_contains docs/acceptance-cases/04_diff.md "cargo test -p deve_cli remote_source_control_proxy_reads_use_delegated_capability -- --nocapture"
check_contains docs/acceptance-cases/04_diff.md "cargo test -p deve_cli delegated_source_control_proxy_api_is_type_marked -- --nocapture"
...
check_contains apps/cli/src/server/tests/source_control/source_control_http_test/status.rs "remote_source_control_proxy_reads_use_delegated_capability"
...
check_contains apps/cli/src/server/source_control_grants/tests.rs "source_control_write_grant_creation_fails_closed"
...
check_absent crates/core/src/ledger/manager/source_control_write_runtime.rs "fn commit_staged_in_local_repo("
check_absent crates/core/src ".commit_staged("
check_absent crates/core/tests ".commit_staged("
check_absent apps/cli/src ".commit_staged("
