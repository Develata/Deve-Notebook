...
case "$STATIC_CHECKS_REQUIRED" in
  1)
    ...
    run node --test "$ROOT_DIR/scripts/mobile-webview-interaction.test.mjs" "$ROOT_DIR/scripts/mobile-editor-session-observation.test.mjs" "$ROOT_DIR/scripts/mobile-keyboard-presentation.test.mjs" "$ROOT_DIR/scripts/android-webview-pointer.test.mjs" "$ROOT_DIR/scripts/android-webview-input-focus.test.mjs" "$ROOT_DIR/scripts/android-drawer-touch-proof.test.mjs" "$ROOT_DIR/scripts/android-native-back-observation.test.mjs" "$ROOT_DIR/scripts/mobile-android-presentation.test.mjs"
