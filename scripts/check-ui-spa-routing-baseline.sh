...
contains apps/cli/src/server/static_files.rs "static_dir_spa_route_returns_index_with_ok_status"
contains apps/cli/src/server/static_files.rs "static_dir_unknown_api_route_does_not_fallback_to_index"
contains apps/cli/src/server/static_files.rs "static_dir_unknown_ws_route_does_not_fallback_to_index"
contains apps/cli/src/server/static_files.rs "static_dir_serves_existing_asset_without_spa_fallback"
