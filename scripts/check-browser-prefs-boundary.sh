...
check_contains apps/web/src/components/settings_prefs.rs "read_i32_pref"
check_contains apps/web/src/components/settings_prefs.rs "write_i32_pref"
...
check_contains apps/web/src/components/settings_prefs.rs "deve.ui.max_document_tabs"
