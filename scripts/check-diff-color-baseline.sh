...
check_contains docs/plan/08_ui_design.md '`--color-added`'
check_contains docs/plan/08_ui_design.md '`--color-modified`'
check_contains docs/plan/08_ui_design.md '`--color-deleted`'
