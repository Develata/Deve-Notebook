...
check_contains apps/cli/src/server/auth/handlers/session.rs "secure_cookies_enabled()"
check_contains apps/cli/src/server/auth/cookie_policy.rs "https_enabled_invalid_value_fails_secure"
...
check_contains docs/acceptance-cases/08_auth.md "dev_session_cookie_secure_follows_policy"
...
check_contains apps/cli/src/server/auth/dev_session.rs ".secure(secure_cookie)"
check_contains apps/cli/src/server/auth/dev_session.rs "fn dev_session_cookie_secure_follows_policy()"
check_contains apps/cli/src/server/auth/browser_session.rs "secure_cookies_enabled()"
