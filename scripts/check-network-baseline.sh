...
check_contains crates/core/src/protocol/frame.rs "pub const WS_PROTOCOL_VERSION: u16 = 8;"
check_contains crates/core/src/protocol/frame.rs "pub const MIN_SUPPORTED_WS_PROTOCOL_VERSION: u16 = 8;"
...
check_contains apps/cli/src/server/ws/receive/tests/frame.rs "Some(\"missing WS frame magic\")"
check_contains apps/cli/src/server/ws/receive/mod.rs "WsFrameFormat::LegacyJsonText"
