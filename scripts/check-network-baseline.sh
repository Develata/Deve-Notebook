...
check_contains apps/cli/src/server/ws/auth.rs "fn bearer_token_matches(token: &str, expected: &str) -> bool"
check_contains apps/cli/src/server/ws/auth.rs "if bearer_token_matches(token, &expected)"
check_absent apps/cli/src/server/ws/auth.rs "token == expected"
...
check_contains docs/acceptance-cases/06_network.md "p2p_connector_retry_backoff_starts_at_one_second"
check_contains docs/acceptance-cases/06_network.md "p2p_connector_jitter_uses_peer_identity_not_label"
check_contains docs/acceptance-cases/06_network.md "load_checked_fails_closed_on_invalid_p2p_peer_id_identity"
check_contains docs/acceptance-cases/06_network.md "static_p2p_peer_id_human_label_rejected"
check_contains crates/core/src/config/validation.rs "canonical identity peer id"
check_contains docker-compose.mesh.yml "00000000000a"
check_contains docker-compose.mesh.yml "00000000000b"
check_contains docs/acceptance-cases/06_network.md "p2p_exchange_rejects_duplicate_sync_hello"
check_contains docs/acceptance-cases/06_network.md "p2p_connector_duplicate_sync_hello_is_terminal"
check_contains apps/cli/src/server/p2p/tests/exchange.rs "async fn p2p_exchange_rejects_duplicate_sync_hello"
check_contains apps/cli/src/server/p2p_connector/tests.rs "fn p2p_connector_duplicate_sync_hello_is_terminal"
check_contains apps/cli/src/server/p2p_connector/tests.rs "fn p2p_connector_retry_backoff_starts_at_one_second"
check_contains apps/cli/src/server/p2p_connector/tests.rs "fn p2p_connector_jitter_uses_peer_identity_not_label"
check_contains apps/cli/src/server/p2p_connector.rs "\"token_invalid\""
check_contains apps/cli/src/server/p2p_connector.rs "\"duplicate_sync_hello\""
