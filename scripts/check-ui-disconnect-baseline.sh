...
check_contains apps/web/src/hooks/use_core/state_init/build/spectator.rs "connection_status.get() != ConnectionStatus::Connected"
...
check_contains apps/web/src/hooks/use_core/write_gate/tests.rs "fn repo_write_gate_blocks_remote_branches_as_read_only()"
