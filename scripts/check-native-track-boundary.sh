...
check_contains docs/report/next-tasks.md "Mobile packaging scaffold plan split"
check_contains docs/report/next-tasks.md "Native packaging dependency gate decision 已关闭"
