...
check_no_process_runtime_leak() {
  ...
  check_contains apps/desktop/src/service_entrypoint.rs "getrandom::fill"
  check_contains apps/desktop/src/service_entrypoint.rs "\"AUTH_SECRET\""
  check_contains apps/desktop/src/service_entrypoint.rs "\"AUTH_PASS\""
  check_contains apps/desktop/src/service_entrypoint.rs "password::hash_password"
  ...
  check_contains apps/desktop/src/tauri_bootstrap.rs "has_native_session_cookie"
  ...
  check_contains apps/desktop/src/tauri_entry.rs "desktop_tauri_native_session_smoke"
  check_contains apps/desktop/src/tauri_entry.rs "desktop-native-session-smoke: ok"
