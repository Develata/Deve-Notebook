...
check_contains apps/desktop/src/tauri_entry/smoke.rs "child_process_runtime_enabled: false"
...
check_contains docs/plan/11_ui_design/02_desktop.md "service readiness/offline"
...
check_contains docs/plan/11_ui_design/03_mobile.md "service readiness/offline"
