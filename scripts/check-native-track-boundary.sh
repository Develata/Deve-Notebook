...
check_no_packaging_dependency_leak() {
  ...
  if [[ -n "$runtime_imports" ]]; then
    while IFS= read -r line; do
      ...
      repo_line_matches "$line" "apps/desktop/src/tauri_bootstrap/mod.rs" && continue
      repo_line_matches "$line" "apps/desktop/src/tauri_bootstrap/cookie.rs" && continue
      repo_line_matches "$line" "apps/desktop/src/tauri_entry/mod.rs" && continue
      repo_line_matches "$line" "apps/mobile/src/tauri_entry.rs" && continue
      repo_line_matches "$line" "apps/mobile/src/embedded_backend/mod.rs" && continue
      repo_line_matches "$line" "apps/mobile/src/embedded_backend/cookie.rs" && continue
...
check_no_process_runtime_leak() {
  ...
  check_contains apps/desktop/src/process_runtime/launcher.rs "command.env(&binding.key, &binding.value)"
  ...
  check_contains apps/desktop/src/service_entrypoint/mod.rs "plan_desktop_local_service_entrypoint_from_env"
  check_contains apps/desktop/src/service_entrypoint/spawn_spec.rs "packaged_cli_sibling"
  ...
  check_contains apps/desktop/src/service_entrypoint/spawn_spec.rs "getrandom::fill"
  ...
  check_contains apps/desktop/src/service_entrypoint/mod.rs "opens_authority_write_path: false"
  ...
  check_contains apps/desktop/src/service_bootstrap/probe.rs "DesktopNativeSessionCookie::from_set_cookie"
  check_contains apps/desktop/src/service_bootstrap/probe.rs "NativeLoopbackHttpProbe"
  check_contains crates/core/src/native_adapter/loopback_http.rs "NativeLoopbackHttpProbe"
  check_contains crates/core/src/native_adapter/loopback_http.rs "Cookie: "
  check_not_contains apps/desktop/src/service_bootstrap/probe.rs "TcpStream::connect_timeout"
  check_not_contains apps/mobile/src/embedded_backend/http.rs "TcpStream::connect_timeout"
  ...
  check_contains apps/desktop/src/tauri_bootstrap/mod.rs "has_native_session_cookie"
  check_contains apps/desktop/src/tauri_bootstrap/mod.rs "desktop_tauri_session_invalid_init_script"
  check_contains apps/desktop/src/tauri_bootstrap/mod.rs "ForbiddenMaterial"
  ...
  check_contains apps/cli/src/server/auth/handlers/native_session.rs "HttpOnly"
  ...
  check_not_contains apps/desktop/src/tauri_entry/mod.rs "plan_desktop_local_service_entrypoint_from_env"
  ...
  check_not_contains apps/desktop/src/tauri_bootstrap/mod.rs "localStorage"
...
check_contains apps/mobile/Cargo.toml '"dep:deve_cli"'
check_contains apps/mobile/Cargo.toml '"dep:getrandom"'
...
check_contains apps/desktop/src/tauri_entry/mod.rs "tauri::Builder::default()"
check_contains apps/desktop/src/tauri_entry/mod.rs "tauri::generate_context!()"
check_contains apps/desktop/src/tauri_entry/smoke.rs "DesktopTauriRuntimeSurface"
check_contains apps/desktop/src/tauri_entry/smoke.rs "local_backend_default_enabled: true"
check_contains apps/desktop/src/tauri_entry/smoke.rs "child_process_runtime_enabled: true"
check_contains apps/desktop/src/tauri_entry/smoke.rs "opens_authority_write_path: false"
check_contains apps/desktop/src/packaging.rs "child_process_runtime_enabled: true"
...
check_contains apps/mobile/src/packaging.rs "embedded_service_runtime_enabled: true"
...
check_contains apps/mobile/src/tauri_entry.rs "embedded_service_runtime_enabled: true"
...
check_contains apps/mobile/src/embedded_backend/mod.rs "start_native_loopback_backend_with_listener"
check_contains apps/mobile/src/embedded_backend/mod.rs "run_mobile_embedded_backend_bootstrap"
check_contains apps/mobile/src/embedded_backend/mod.rs "mobile_embedded_backend_plugin"
check_contains apps/mobile/src/embedded_backend/mod.rs "NativeLoopbackAuthMaterial"
check_contains apps/mobile/src/embedded_backend/mod.rs "into_native_loopback_auth_material"
...
check_contains apps/mobile/src/embedded_backend/mod.rs "opens_authority_write_path: false"
check_contains apps/mobile/src/embedded_backend/http.rs "/api/auth/native-session"
check_contains apps/mobile/src/embedded_backend/http.rs "NATIVE_SESSION_BOOTSTRAP_HEADER"
check_contains apps/mobile/src/embedded_backend/cookie.rs "HttpOnly"
...
check_contains apps/web/src/api/connection_role.rs "probe_node_role_for_http_base"
...
check_contains docs/plan/11_ui_design/02_desktop.md "{#desktop-current-native-boundary}"
check_contains docs/plan/11_ui_design/02_desktop.md "**Current Native Boundary**"
check_contains docs/plan/11_ui_design/02_desktop.md "**Post-Gate Target**"
check_contains docs/plan/11_ui_design/02_desktop.md "post-gate normative target"
check_contains docs/plan/11_ui_design/02_desktop.md "Tauri v2 native packaging"
check_contains docs/plan/11_ui_design/02_desktop.md "native-packaging"
check_contains docs/plan/11_ui_design/02_desktop.md "{#desktop-packaging-scaffold}"
check_contains docs/plan/11_ui_design/02_desktop.md "{#desktop-packaging-dependency-gate-decision}"
check_contains docs/plan/11_ui_design/02_desktop.md "Native adapter **MUST NOT**"
check_contains docs/plan/11_ui_design/02_desktop.md "readiness/offline 状态"
check_contains docs/plan/11_ui_design/02_desktop.md "loopback/IPC endpoint"
check_contains docs/plan/11_ui_design/02_desktop.md "{#desktop-native-adapter-contract}"
check_contains docs/plan/11_ui_design/02_desktop.md "NativeEndpointReady { http_base, ws_base, node_role, session_bound }"
check_contains docs/plan/11_ui_design/02_desktop.md "writer_ready(repo_id, scope_nonce)"
check_contains docs/plan/11_ui_design/02_desktop.md "08_auth.md#unauthorized-disconnected-ui"
check_contains docs/plan/11_ui_design/02_desktop.md "native 层不得直接写 ledger/Projection Workspace/source-control/search index"

check_contains docs/plan/11_ui_design/03_mobile.md "{#mobile-current-native-boundary}"
check_contains docs/plan/11_ui_design/03_mobile.md "**Current Native Boundary**"
check_contains docs/plan/11_ui_design/03_mobile.md "**Post-Gate Target**"
check_contains docs/plan/11_ui_design/03_mobile.md "post-gate normative target"
check_contains docs/plan/11_ui_design/03_mobile.md "Tauri v2 Mobile packaging"
check_contains docs/plan/11_ui_design/03_mobile.md "native-packaging"
check_contains docs/plan/11_ui_design/03_mobile.md "{#mobile-packaging-scaffold}"
check_contains docs/plan/11_ui_design/03_mobile.md "{#mobile-packaging-dependency-gate-decision}"
check_contains docs/plan/11_ui_design/03_mobile.md "{#mobile-android-shell-package-execution-gate}"
check_contains docs/plan/11_ui_design/03_mobile.md "{#mobile-ios-shell-package-execution-gate}"
check_contains docs/plan/11_ui_design/03_mobile.md "Mobile native adapter **MUST NOT**"
check_contains docs/plan/11_ui_design/03_mobile.md "readiness/offline 状态"
check_contains docs/plan/11_ui_design/03_mobile.md "loopback/IPC endpoint"
check_contains docs/plan/11_ui_design/03_mobile.md "{#mobile-native-adapter-contract}"
check_contains docs/plan/11_ui_design/03_mobile.md "NativeEndpointReady { http_base, ws_base, node_role, session_bound }"
check_contains docs/plan/11_ui_design/03_mobile.md "BackgroundSuspended"
check_contains docs/plan/11_ui_design/03_mobile.md "ForegroundReprobe"
check_contains docs/plan/11_ui_design/03_mobile.md "writer_ready(repo_id, scope_nonce)"
check_contains docs/plan/11_ui_design/03_mobile.md "safe-area、keyboard、foreground/background、network online/offline"
check_contains docs/plan/11_ui_design/03_mobile.md "Android shell-only package execution gate"
check_contains docs/plan/11_ui_design/03_mobile.md "Android package build **MUST NOT** 启动、持有、重启后端子进程"
check_contains docs/plan/11_ui_design/03_mobile.md "iOS shell-only package execution gate"
check_contains docs/plan/11_ui_design/03_mobile.md "iOS package build **MUST NOT** 启动、持有、重启后端子进程"

check_contains docs/plan/17_tech_stack.md "{#native-packaging-dependency-gate}"
check_contains docs/plan/17_tech_stack.md "native-packaging"
check_contains docs/plan/17_tech_stack.md "CURRENT_NATIVE_PACKAGING_DEPENDENCY_GATE_POLICY"
check_contains docs/plan/17_tech_stack.md "不得进入 workspace root"
check_contains docs/plan/17_tech_stack.md "Desktop packaging dependency spike"
check_contains docs/plan/17_tech_stack.md "Mobile packaging dependency spike"
...
check_contains docs/features/operations/tech_stack_platform_release_channel.md "native::shell_mode"
