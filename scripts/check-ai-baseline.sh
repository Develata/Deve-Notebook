...
check_contains docs/plan/14_commands.md "Future UI Surface"
...
check_contains docs/plan/16_ai_agent.md "用作后端切换命令"
check_contains docs/plan/14_commands.md "\`/agents\`: 在原生 \`PLAN ↔ BUILD\` 之间顺序切换。"
...
check_contains docs/plan/16_ai_agent.md "default-off、policy-gated 的 Trusted CLI path"
check_contains docs/plan/16_ai_agent.md "DEVE_AI_AGENT_BRIDGE_ENABLED"
check_contains docs/plan/16_ai_agent.md "DEVE_AI_AGENT_BRIDGE_TRUSTED"
check_contains docs/plan/17_tech_stack.md "Native Baseline"
check_contains docs/plan/17_tech_stack.md "Optional Trusted Path"
check_contains docs/plan/17_tech_stack.md "Compatibility Host + Interface Reserved"
...
check_contains docs/plan/19_plugins.md "Calculation Runtime 仍然是长期能力，但本章**不要求代码实现**"
...
check_contains docs/plan/19_plugins.md "<projection_base>/<repo_name>/**/*.md"
check_contains docs/plan/19_plugins.md ".notegit"
check_contains docs/plan/19_plugins.md "ledger-aware host functions"
