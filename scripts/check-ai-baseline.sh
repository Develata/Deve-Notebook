...
check_contains docs/plan/14_tech_stack.md "Verified (Minimum Native)"
check_contains docs/plan/14_tech_stack.md "Partial (Trusted CLI Policy-Gated)"
check_contains docs/plan/14_tech_stack.md "Boundary Reserved / Compatibility Host"
