...
(group :id grp.user.plugin-runtime :layer user-operation :label "plugin-host / plugin-call boundary" :members (op.plugin.host.resume-runtime op.plugin.call.submit op.plugin.call.receive-result op.plugin.call.receive-error))
...
(user-operation :id op.plugin.host.resume-runtime :label "Resume Plugin Host Boundary" :kind resume :surface peripheral-runtime :code "apps/cli/src/commands/{serve.rs,serve_support.rs} | apps/cli/src/server/{plugin_host.rs,plugin_host_ws.rs}" :calls (app.plugin.host.proxy-detect app.plugin.host.load-strict app.plugin.host.start-host))
(user-operation :id op.plugin.call.submit :label "Submit PluginCall" :kind request :surface peripheral-runtime :code "apps/cli/src/server/{plugin_host_ws.rs,handlers/plugin.rs,ws/route/core.rs}" :calls (app.plugin.call.dispatch))
(user-operation :id op.plugin.call.receive-result :label "Receive PluginResponse" :kind async-result :surface peripheral-runtime :code "apps/cli/src/server/{plugin_response.rs,plugin_host_ws.rs}" :calls (app.plugin.call.result))
(user-operation :id op.plugin.call.receive-error :label "Receive Plugin Error" :kind async-result :surface peripheral-runtime :code "apps/cli/src/server/{handlers/plugin.rs,plugin_response.rs,plugin_host_ws.rs}" :calls (app.plugin.call.error))
...
(group :id grp.app.plugin-runtime :layer application :label "plugin-host / plugin-call boundary" :members (app.plugin.host.proxy-detect app.plugin.host.load-strict app.plugin.host.start-host app.plugin.call.dispatch app.plugin.call.result app.plugin.call.error))
...
(application :id app.plugin.host.proxy-detect :label "serve::start_proxy_mode / detect_main_port" :kind runtime-gate :code "apps/cli/src/commands/serve.rs" :calls ())
(application :id app.plugin.host.load-strict :label "PluginLoader::load_all_strict" :kind runtime-effect :code "apps/cli/src/commands/serve_support.rs | crates/core/src/plugin/loader.rs" :calls (mod_plugin_loader))
(application :id app.plugin.host.start-host :label "plugin_host::start_plugin_host_only / ws_handler" :kind runtime-effect :code "apps/cli/src/server/{plugin_host.rs,plugin_host_ws.rs}" :calls (mod_plugin_host mod_proto_ws))
(application :id app.plugin.call.dispatch :label "ClientMessage::PluginCall -> handle_plugin_call" :kind ws-handler :code "apps/cli/src/server/{plugin_host_ws.rs,handlers/plugin.rs,ws/route/core.rs}" :calls (mod_plugin_rhai mod_plugin_host mod_proto_ws))
(application :id app.plugin.call.result :label "ServerMessage::PluginResponse" :kind async-result :code "apps/cli/src/server/plugin_response.rs" :calls (mod_plugin_rhai mod_proto_ws))
(application :id app.plugin.call.error :label "PluginInvalidMessage / Unsupported / RequestFailed" :kind async-result :code "apps/cli/src/server/{handlers/plugin.rs,plugin_response.rs,plugin_host_ws.rs}" :calls (mod_plugin_host mod_proto_ws))
...
(group :id grp.mod.plugin-runtime :layer module :label "plugin-host / plugin-call boundary" :members (mod_plugin_loader mod_plugin_host mod_plugin_rhai mod_proto_ws))
...
(module :id mod_plugin_loader :label "plugin::loader" :parent core.plugin :code "crates/core/src/plugin/loader.rs")
(module :id mod_plugin_host :label "plugin::runtime::host" :parent core.plugin :code "crates/core/src/plugin/runtime/host/")
(module :id mod_plugin_rhai :label "plugin::runtime::rhai_v1" :parent core.plugin :code "crates/core/src/plugin/runtime/rhai_v1.rs")
...
(group :id grp.core.plugin-runtime :layer core :label "plugin-host / plugin-call boundary" :members (core.plugin core.protocol))
