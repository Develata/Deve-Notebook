...
(group :id grp.user.shared-web-desktop :layer user-operation :kind platform-intersection :label "shared(web,desktop)" :members (grp.user.auth-login grp.user.auth-session grp.user.command-palette grp.user.sync-handshake grp.user.key-exchange grp.user.sync-transfer grp.user.branch-switch grp.user.repo-switch grp.user.sc-stage grp.user.sc-discard-file grp.user.sc-discard grp.user.sc-conflict grp.user.sc-commit grp.user.sc-history grp.user.sc-commit-publish grp.user.sc-merge-peer grp.user.sc-merge-runtime grp.user.ai-chat grp.user.plugin-runtime grp.user.open-doc))
...
(user-operation :id op.plugin.host.resume-runtime :label "Resume Plugin Host Boundary" :kind resume :surface peripheral-runtime :chapter 17_plugins :feature "docs/features/operations/plugin_runtime_boundary.md" :calls (app.plugin.host.proxy-detect app.plugin.host.load-strict app.plugin.host.start-host))
(user-operation :id op.plugin.call.submit :label "Submit PluginCall" :kind request :surface peripheral-runtime :chapter 17_plugins :feature "docs/features/operations/plugin_runtime_boundary.md" :calls (app.plugin.call.dispatch))
(user-operation :id op.plugin.call.receive-result :label "Receive PluginResponse" :kind async-result :surface peripheral-runtime :chapter 17_plugins :feature "docs/features/operations/plugin_runtime_boundary.md" :calls (app.plugin.call.result))
(user-operation :id op.plugin.call.receive-error :label "Receive Plugin Error" :kind async-result :surface peripheral-runtime :chapter 17_plugins :feature "docs/features/operations/plugin_runtime_boundary.md" :calls (app.plugin.call.error))
...
(application :id app.plugin.host.proxy-detect :label "serve::detect_main_port / start_proxy_mode" :kind runtime-gate :chapter 17_plugins :calls ())
(application :id app.plugin.host.load-strict :label "serve_support::load_plugins" :kind runtime-effect :chapter 17_plugins :calls (mod_plugin_loader))
(application :id app.plugin.host.start-host :label "server::start_plugin_host_only" :kind runtime-effect :chapter 17_plugins :calls (mod_plugin_host mod_proto_ws))
(application :id app.plugin.call.dispatch :label "plugin::handle_plugin_call" :kind ws-handler :chapter 17_plugins :calls (mod_plugin_rhai mod_plugin_host mod_proto_ws))
(application :id app.plugin.call.result :label "PluginResponse" :kind async-result :chapter 17_plugins :calls (mod_plugin_rhai mod_proto_ws))
(application :id app.plugin.call.error :label "PluginInvalid/Unsupported/Failed" :kind async-result :chapter 17_plugins :calls (mod_plugin_host mod_proto_ws))
...
(module :id mod_plugin_loader   :label "plugin::loader" :chapter 17_plugins :parent core.plugin :code-area "crates/core/src/plugin/loader.rs")
(module :id mod_plugin_host     :label "plugin::runtime::host" :chapter 17_plugins :parent core.plugin :code-area "crates/core/src/plugin/runtime/host/")
(module :id mod_plugin_rhai     :label "plugin::runtime::rhai_v1" :chapter 17_plugins :parent core.plugin :code-area "crates/core/src/plugin/runtime/rhai_v1.rs")
