...
- P2 AI Settings UI acceptance depth 已关闭：Settings AI backend button 状态已提取为纯 policy 并补代码级测试；可用 backend 不再显示 disabled fallback title，不可用 backend 才显示原因，详见 `ai-settings-ui-acceptance-depth-2026-04-30.md`。
