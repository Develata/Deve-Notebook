...
- P2 Settings Reserved UI acceptance depth 已关闭：Hybrid Editing 预留项现在由 `reserved_setting_state(Locale)` 提供 disabled marker、title 与可见原因；旧 `Phase 6` 文案已替换为 current-release-unavailable 边界文案，详见 `settings-reserved-ui-acceptance-depth-2026-04-30.md`。
