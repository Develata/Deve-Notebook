...
| 顺序 | TODO | 优先级 | 范围 | 验收口径 |
|:--|:--|:--|:--|:--|
| 1 | Desktop native shell skeleton | P3-10 | future `apps/desktop/` 或等价 shell crate, Web bootstrap injection docs | 壳层只负责启动/探测受控服务、完成 session material 绑定并注入 Web bootstrap；不得直接写 ledger/vault/source-control/search。 |
