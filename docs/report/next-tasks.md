...
1. Mobile Platform Package Build Preflight：在 Mobile shell manifest acceptance 稳定后，新增 Android/iOS target-host prerequisite diagnostic；不得在 Linux/WSL 上声明移动端 package ready。
