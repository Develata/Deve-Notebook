...
The next native-track step should follow `next-tasks.md`; preserve the
no-Tauri desktop shell skeleton as the fast unit-test boundary and do not open
the real Tauri dependency gate by default.
