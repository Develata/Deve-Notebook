...
- `Application Entry`: `apps/web/src/hooks/use_core/effects/message_control_runtime_repo_requests.rs`
...
- `Application Entry`: `apps/web/src/hooks/use_core/callbacks_sync_read.rs`, `apps/cli/src/server/ws/route/merge.rs`, `apps/cli/src/server/handlers/merge/manual.rs`
...
- `Application Entry`: `apps/web/src/hooks/use_core/effects/message_dispatch_route_projection_sync.rs`, `apps/web/src/hooks/use_core/effects/message_runtime_sync.rs`
