# external_changes.md - External Changes 操作流示例
...
- `Application Entry`: `apps/web/src/components/sidebar/external_changes.rs`, `apps/web/src/hooks/use_core/contexts/external_changes.rs`, `apps/cli/src/server/ws/route/source_control.rs`
...
- `Application Entry`: `apps/web/src/components/sidebar/external_changes.rs`, `apps/web/src/hooks/use_core/callbacks_sc/write/targets.rs`
...
- `Application Entry`: `apps/web/src/components/sidebar/external_changes.rs`, `apps/cli/src/server/handlers/source_control/http_mutations/mod.rs`
...
- `Application Entry`: `crates/core/src/ledger/manager/commit_runtime.rs`, `apps/cli/src/server/handlers/source_control/service/write.rs`, `apps/web/src/components/sidebar/external_changes.rs`
...
- `Application Entry`: `crates/core/src/source_control/`, `apps/web/src/components/sidebar/external_changes.rs`
