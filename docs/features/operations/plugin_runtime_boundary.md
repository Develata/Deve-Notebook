...
- `Application Entry`: `apps/cli/src/server/plugin_host/ws_host.rs`, `apps/cli/src/server/handlers/plugin.rs`, `apps/cli/src/server/ws/route/core.rs`
...
- `Application Entry`: `apps/cli/src/server/plugin_response.rs`, `apps/cli/src/server/plugin_host/ws_host.rs`
...
- `Application Entry`: `apps/cli/src/server/handlers/plugin.rs`, `apps/cli/src/server/plugin_response.rs`, `apps/cli/src/server/plugin_host/ws_host.rs`
