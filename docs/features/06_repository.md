...
- `backup restore --dry-run` 只能展示 flow planning；在 provider download、
  manifest verification、artifact open 与 PacksDecrypted evidence 全链路完成前，不得
  呈现为 RestoreCandidate 已创建。
