...
Implementation status after B4: Ledger payload v3、Redb schema v4、Remote Import
backend/CLI product wire、Mounted admission 与 post-commit writeback 已对齐；旧
pull/continuation/External Changes bridge 已删除。Projection Locator/C1′ alias、F4/v4 Repo
Control、A1/B1 catalog/lifecycle、B5 client 与 B6 evidence remain explicit blockers.
