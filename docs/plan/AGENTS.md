...
| `07_network#repo-control-wire-contract` | `### 4.3.2 Repo Control Wire Contract` | F4/v4 nested host-local alias/lifecycle request、completion 与 exact RepoId projection |
