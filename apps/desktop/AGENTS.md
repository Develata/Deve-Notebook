...
- Do not add or expand Tauri/platform packaging dependencies without updating `docs/plan/11_ui_design/02_desktop.md`, `docs/plan/17_tech_stack.md`, and `scripts/check-native-track-boundary.sh`.
