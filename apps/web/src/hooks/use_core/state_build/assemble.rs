...
pub(super) fn assemble_core_state(
    ...
    let runtime_clients = CoreRuntimeClients {
        ...
        scope: ScopeClient {
            ...
            removal_preview: switch.removal_preview,
            on_confirm_remove_repo: switch.on_confirm_remove_repo.clone(),
            on_cancel_remove_repo: switch.on_cancel_remove_repo.clone(),
