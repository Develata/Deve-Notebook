...
pub(super) fn assemble_core_signals_with_spectator(
    ...
    CoreSignals {
        ...
        remove_scope_partial_stage: repo.remove_scope_partial_stage,
        set_remove_scope_partial_stage: repo.set_remove_scope_partial_stage,
        explicit_repo_selection_required: repo.explicit_repo_selection_required,
        set_explicit_repo_selection_required: repo.set_explicit_repo_selection_required,
