...
pub fn use_core() -> CoreState {
    ...
    let state = CoreState {
        ...
        sc_bulk_progress: signals.sc_bulk_progress,
        set_sc_bulk_progress: signals.set_sc_bulk_progress,
        sc_bulk_failed_paths: signals.sc_bulk_failed_paths,
        set_sc_bulk_failed_paths: signals.set_sc_bulk_failed_paths,
