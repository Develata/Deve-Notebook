                            ...
                            children=move |repo_name| {
                                ...
                                view! {
                                    <div
                                        ...
                                        on:click=move |_| {
                                            leptos::logging::log!("Switching to repo: {}", repo_name_for_click);
                                            // 使用 PeerId newtype 构造器
                                            core.set_active_repo.set(Some(deve_core::models::PeerId(repo_name_for_click.clone())));
                                        }
                                    >
                                        <div class="flex items-center overflow-hidden">
                                            ...
                                            <span class="truncate font-medium">{repo_name_display}.redb</span>
                                        </div>

                                        // Action Buttons (e.g. Settings, Compact)
                                        <div class="hidden group-hover:!flex items-center gap-1">
                                            <button class="p-0.5 hover:bg-[#d0d0d0] rounded" title="Database Settings" on:click=move |e| e.stop_propagation()>
