            ...
            >
                <Show when=move || write_block.get().is_none()>
                    <button
                        ...
                        data-deve-sc-action="discard-all"
                        ...
                        aria-label=move || t::source_control::discard_all_changes(locale.get())
