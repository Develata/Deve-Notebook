...
pub fn MobileFooter(core: CoreState) -> impl IntoView {
    ...
    let status_view = move || {
        ...
        view! {
            <div class="flex items-center gap-1.5">
                ...
                <span class="text-[11px] text-gray-600 font-medium">{text}</span>
            </div>
        }
    };
    ...
    view! {
        ...
        <footer
            class="relative z-50 bg-white border-t border-gray-200 px-2 py-1.5 flex flex-col gap-1.5"
        ...
        >
            <div class="flex items-center gap-1.5">
                <div class="flex-1 min-w-0 flex items-center gap-1 whitespace-nowrap overflow-hidden">
                    ...
                    <div class="shrink-0 px-1.5 h-6 rounded-md bg-gray-50 border border-gray-200 flex items-center">
                        {status_view}
                    </div>
                    <div class="shrink-0 h-6 rounded-md bg-gray-50 border border-gray-200 px-1.5 flex items-center gap-1 text-[10px] text-gray-500">
                ...
                <button
                    class="h-11 min-w-11 p-1.5 rounded-md active:bg-gray-100 flex items-center justify-center"
                ...
                >
                    {move || if expanded.get() {
                        view! {
                            <span class="h-8 w-8 rounded-md border border-gray-200 bg-white text-gray-600 flex items-center justify-center">
            ...
            <Show when=move || expanded.get()>
                <div class="flex items-center gap-2 overflow-x-auto pb-0.5 scrollbar-none">
                    <Show when=move || load_state.get() != "ready">
                        <div class="shrink-0 px-2 h-7 rounded-md bg-gray-50 border border-gray-200 flex items-center">
                            {load_status}
                        </div>
                    </Show>
                    <div class="shrink-0 text-[10px] text-gray-500 font-mono px-1">
