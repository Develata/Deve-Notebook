...
pub fn ActivityBar(
    ...
    view! {
        <div class="w-full h-10 flex flex-row items-center px-1 bg-[#f3f3f3] dark:bg-[#252526] border-b border-[#e5e5e5] dark:border-[#1e1e1e] flex-none z-20 overflow-x-auto no-scrollbar">
            // 顶部区域 -> 左侧区域
            ...
            // 底部:设置 -> 右侧:设置
            <button 
                class="p-2 mr-1 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 rounded-lg transition-colors"
                title="Settings"
