...
Search interface with file operations support. Provides full-text search, search providers, result rendering, and mobile sheet gesture integration.
...
| `ui_sections.rs` | Search result sections |
| `sheet_gesture.rs` | Mobile sheet gesture for search |
