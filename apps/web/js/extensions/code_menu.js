...
export function showMenu(anchor, context) {
    ...
    menu.className = "absolute top-full right-0 mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg rounded py-1 text-xs z-50 min-w-[120px]";
    ...
    if (actions.length === 0) {
        ...
        for (const action of actions) {
            ...
            item.className = "w-full px-3 py-1.5 text-left hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 transition-colors";
