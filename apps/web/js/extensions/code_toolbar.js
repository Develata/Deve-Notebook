 ...
 * Plugin actions can be registered via the bridge-registered `deve_code_actions` facade.
 */
class CodeToolbarWidget extends WidgetType {
    ...
    toDOM(view) {
        ...
        copyBtn.setAttribute("data-deve-code-toolbar-action", "copy");
        ...
        menuBtn.setAttribute("data-deve-code-toolbar-action", "ellipsis");
