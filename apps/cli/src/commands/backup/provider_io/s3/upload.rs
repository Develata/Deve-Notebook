...
use super::transport::{ReqwestS3BackupTransport, S3BackupUploadTransport};
...
fn upload_s3_pack_with_transport<T: S3BackupUploadTransport>(
    locator: &BackupLocator,
...
#[cfg(test)]
mod tests {
    use super::super::signing::S3SignedBackupPutRequest;
    use super::*;
