...
impl AppliedPullFiles {
    ...
    pub(in crate::commands::projection_remote) fn defer_rollback(mut self) -> Self {
    ...
    pub(in crate::commands::projection_remote) fn rollback_after_failed_scan_if_unchanged(
        mut self,
    ) -> Result<(), RemoteProjectionProviderError> {
