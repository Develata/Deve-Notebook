...
//!
//! F4/v6 Remote Import wire contract tests.
...
#[test]
fn remote_import_nested_wire_roundtrip_in_f4_v6_binary_and_versioned_json() {
    for request in request_variants() {
        ...
        let frame = decode_client_binary_frame(&binary).expect("decode F4/v6 client frame");
