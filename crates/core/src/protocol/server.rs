...
pub enum ServerMessage {
    ...
    SyncSnapshotRequest { peer_id: PeerId, repo_id: RepoId, #[serde(default)] known_vector: VersionVector, #[serde(default)] reason: Option<String> },
    SyncPush { peer_id: PeerId, repo_id: RepoId, scope_nonce: u64, #[serde(default)] branch: Option<PeerId>, ops: Vec<EncryptedOp> },
    SyncPushSnapshot { peer_id: PeerId, repo_id: RepoId, scope_nonce: u64, #[serde(default)] branch: Option<PeerId>, #[serde(default)] server_vector: VersionVector, #[serde(default)] snapshot_kind: Option<String>, ops: Vec<EncryptedOp> },
    ...
    EditRejected { scope_nonce: u64, doc_id: DocId, client_op_id: u64, error: ServerError },
