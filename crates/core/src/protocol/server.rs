...
pub enum ServerMessage {
    ...
    SyncSnapshotRequest { peer_id: PeerId, repo_id: RepoId, #[serde(default)] known_vector: VersionVector },
    SyncPush { peer_id: PeerId, repo_id: RepoId, scope_nonce: u64, #[serde(default)] branch: Option<PeerId>, ops: Vec<EncryptedOp> },
    SyncPushSnapshot { peer_id: PeerId, repo_id: RepoId, scope_nonce: u64, #[serde(default)] branch: Option<PeerId>, #[serde(default)] server_vector: VersionVector, ops: Vec<EncryptedOp> },
