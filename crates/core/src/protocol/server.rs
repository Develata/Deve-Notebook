...
pub enum ServerMessage {
    ...
    DocList { #[serde(default)] request_id: Option<String>, #[serde(default)] repo_id: Option<RepoId>, #[serde(default)] branch: Option<PeerId>, docs: Vec<(DocId, String)> },
    ...
    SyncModeStatus { #[serde(default)] request_id: Option<String>, #[serde(default)] repo_id: Option<RepoId>, #[serde(default)] branch: Option<PeerId>, mode: String },
    PendingOpsInfo { #[serde(default)] request_id: Option<String>, #[serde(default)] repo_id: Option<RepoId>, #[serde(default)] branch: Option<PeerId>, count: u32, previews: Vec<(String, String, String)> },
    ...
    ShadowList { #[serde(default)] request_id: Option<String>, shadows: Vec<String> },
    RepoList { #[serde(default)] request_id: Option<String>, #[serde(default)] branch: Option<String>, repos: Vec<String> },
    ...
    ChangesList { #[serde(default)] request_id: Option<String>, #[serde(default)] repo_id: Option<RepoId>, #[serde(default)] branch: Option<PeerId>, staged: Vec<ChangeEntry>, unstaged: Vec<ChangeEntry> },
    ...
    CommitHistory { #[serde(default)] request_id: Option<String>, #[serde(default)] repo_id: Option<RepoId>, #[serde(default)] branch: Option<PeerId>, commits: Vec<CommitInfo> },
    DocDiff { #[serde(default)] request_id: Option<String>, #[serde(default)] repo_id: Option<RepoId>, #[serde(default)] branch: Option<PeerId>, path: String, old_content: String, new_content: String },
    CommitDiffResult { #[serde(default)] request_id: Option<String>, #[serde(default)] repo_id: Option<RepoId>, #[serde(default)] branch: Option<PeerId>, diffs: Vec<CommitFileDiff> },
    DocDeleted { doc_id: DocId },
    DiscardAck { #[serde(default)] repo_id: Option<RepoId>, #[serde(default)] branch: Option<PeerId>, path: String },
    TreeUpdate { #[serde(default)] request_id: Option<String>, #[serde(default)] repo_id: Option<RepoId>, #[serde(default)] branch: Option<PeerId>, delta: crate::tree::TreeDelta },
