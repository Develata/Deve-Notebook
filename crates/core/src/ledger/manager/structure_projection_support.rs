...
pub(super) fn child_path(db: &Database, parent_id: Option<NodeId>, name: &str) -> Result<String> {
...
pub(super) fn load_meta(db: &Database, node_id: NodeId, doc_id: Option<DocId>) -> Result<NodeMeta> {
