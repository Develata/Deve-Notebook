...
const MANIFEST_DEPENDENCIES: &[(&str, &str, &str)] = &[
    ...
    ("apps/mobile/Cargo.toml", "block2", "0.6.2"),
    ("apps/mobile/Cargo.toml", "objc2", "0.6.4"),
    ("apps/mobile/Cargo.toml", "objc2-core-foundation", "0.3.2"),
    ("apps/mobile/Cargo.toml", "objc2-foundation", "0.3.2"),
    ("apps/mobile/Cargo.toml", "objc2-ui-kit", "0.3.2"),
...
const TAURI_IMPORT_ALLOWED: &[&str] = &[
    ...
    "apps/desktop/src/tauri_entry/native_backend_commands.rs",
