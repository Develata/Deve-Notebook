...
fn run() -> Result<()> {
    ...
    match command.as_str() {
        ...
        "acceptance-impact-backlog" => acceptance_matrix::run_impact_backlog(),
        "acceptance-impact-shadow" => acceptance_matrix::run_impact_shadow(&command_args),
